...
// if not submitted then get data
		...
		$type_team_work = $workshop[20];
		$type_managers = $workshop[21];
		$type_workers =  $workshop[22];
		$type_lectures = $workshop[23];
		$type_teachers = $workshop[24];
		$type_fun = $workshop[25];
		
		$loc_building = $workshop[26];
		$loc_our_place = $workshop[27];
		$loc_outside = $workshop[28];
